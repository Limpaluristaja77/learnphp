<?php __DIR__ . '/partials/header.php'; ?>
<?php __DIR__ . '/partials/theme.php'; ?>
<?php __DIR__ . '/partials/nav.php'; ?>




    <main class="container">
      <?php __DIR__ . '/partials/hero.php'; ?>
      <?php __DIR__ . '/partials/feature.php'; ?>

      <div class="row g-5">
        <div class="col-md-8">
          <?php __DIR__ . '/partials/posts.php'; ?>

        </div>
        <div class="col-md-4">
          <?php __DIR__ . '/partials/sidebar.php'; ?>
